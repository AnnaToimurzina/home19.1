                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Товар 1</h4> </div>
                        <div class="card-body">
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            <form>
                                <div class="mb-3">
                                <input name="name type="text" class="form-control" id="exampleInputEmail1" placeholder="Имя" aria-describedby="emailHelp"> </div>

                                <div class="mb-3">
                                <input name="email" type="email" class="form-control" id="exampleInputEmail2" placeholder="Email" aria-describedby="emailHelp">
                                    <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div><div class="mb-3 form-check">
                  ...
                  <div class="col">
                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                      <div class="card card-body">
                        Для покупки товара необходимо добавить его в корзину и оформить заказ на странице оформления.
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="collapse multi-collapse" id="multiCollapseExample2">
                      <div class="card card-body">
                        Мы осуществляем доставку нашего товара в течение 3-5 рабочих дней после оформления заказа.
                      </div>
                    </div>
                  </div>
                    <div class="col">
                        <div class="collapse multi-collapse" id="multiCollapseExample3">
                          <div class="card card-body">
                            На все наши товары предоставляется гарантия сроком на один год с момента покупки.
                          </div>
                        </div>
                    </div>
        </main>
